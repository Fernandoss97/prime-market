...
-   This project uses Mary UI as its component library for Livewire applications.
-   Mary UI is a comprehensive UI component library built with Tailwind CSS and DaisyUI, providing a rich set of components that are easy to use and customize.
-   You should use Mary UI components when available.
-   Fallback to standard Blade components if Mary UI is unavailable.
-   If available, use Laravel Boost's `search-docs` tool to get the exact documentation and code snippets available for this project.
-   Mary UI components look like this:

<code-snippet name="Mary UI Component Usage Example" lang="blade">
    <x-mary-button label="Click me" class="btn-primary" />
</code-snippet>
...
<available-mary-components>
avatar, badge, button, card, checkbox, dropdown, form, header, icon, input, modal, navbar, select, separator, switch, table, tabs, textarea, toggle, tooltip
</available-mary-components>
...
<code-snippet name="Loading States With Volt" lang="php">
    <x-mary-button wire:click="save" wire:loading.attr="disabled">
